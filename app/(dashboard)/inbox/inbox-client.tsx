      ...
      <div className="flex-1 flex bg-white border border-[#D8E0EA] rounded-2xl overflow-hidden shadow-sm min-h-0">
        ...
        <div className="w-[360px] border-r border-[#D8E0EA] flex flex-col shrink-0 min-h-0">
          ...
          <div className="p-4 border-b border-[#D8E0EA] space-y-3 shrink-0 bg-slate-50/50">
            {/* Tabs Selector */}
            <div className="flex gap-1 p-0.5 bg-slate-100 dark:bg-slate-900/50 rounded-lg border border-slate-200/50 dark:border-slate-800 text-[11px] font-bold">
              <button
                type="button"
                ...
                className={`flex-1 py-1.5 rounded-md text-center transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                  activeTab === 'received'
                    ? 'bg-white dark:bg-[#1e2e4d] text-[#002B6A] dark:text-[#60a5fa] shadow-sm font-extrabold'
                    : 'text-[#475569]/80 dark:text-slate-400 hover:text-[#002B6A] dark:hover:text-white'
                }`}
              >
            ...
            {activeTab === 'received' && (
              <div className="flex gap-1.5 p-0.5 bg-slate-100 dark:bg-slate-900/50 rounded-lg border border-slate-200/50 dark:border-slate-800 text-[11px] font-semibold">
                {(['all', 'unread', 'read'] as const).map(f => (
                  <button
                    ...
                    className={`flex-1 py-1 rounded-md text-center transition-all cursor-pointer ${
                      filter === f
                        ? 'bg-white dark:bg-[#1e2e4d] text-[#002B6A] dark:text-[#60a5fa] shadow-sm font-bold'
                        : 'text-[#475569]/80 dark:text-slate-400 hover:text-[#002B6A] dark:hover:text-white'
                    }`}
                  >
          ...
          {/* List Container */}
          <div className="flex-1 overflow-y-auto divide-y divide-[#D8E0EA]/75 dark:divide-slate-800 min-h-0">
            {activeTab === 'received' ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  {activeTab === 'received' && selectedReply && (
                    <button
                      ...
                      className="p-2 border border-rose-100 dark:border-rose-900/50 bg-rose-50 dark:bg-rose-950/20 hover:bg-rose-100 dark:hover:bg-rose-950/40 rounded-lg text-rose-600 dark:text-rose-400 transition-all cursor-pointer shadow-sm"
              ...
              {activeTab === 'received' && selectedReply ? (
                <>
                  <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-0 bg-slate-50/50">
                    ...
                    <div className="bg-white border border-[#D8E0EA]/75 dark:border-slate-800 rounded-2xl p-5 space-y-3 shadow-xs max-w-2xl mx-auto">
                    ...
                    <div className="bg-[#EAF2FF]/20 dark:bg-blue-950/20 border border-[#2D6BFF]/15 dark:border-blue-900/30 rounded-2xl p-5 space-y-3 shadow-xs max-w-2xl mx-auto border-l-4 border-l-[#2D6BFF]">
                      <div className="flex justify-between items-start">
                        <div>
                ...
                (() => {
                  ...
                  return (
                    <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-0 bg-slate-50/50">
                      <div className="bg-white border border-[#D8E0EA]/75 dark:border-slate-800 rounded-2xl p-5 space-y-3 shadow-xs max-w-2xl mx-auto border-l-4 border-l-emerald-500">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="text-xs font-bold text-[#002B6A] flex items-center gap-1.5">
